    ...
    <section id="about" className="relative py-28 overflow-hidden bg-[#F8F4EF]">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="max-w-xl">
          ...
          <h2
            className="font-cormorant font-semibold text-[#2D1654] leading-tight mb-6"
          ...
          <p className="text-[#2D1654]/80 leading-relaxed mb-5 font-jost">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.k} className="border-t-2 border-[#C8A84B] pt-4">
                <p className="font-cormorant text-4xl text-[#2D1654] font-semibold">{item.k}</p>
                <p className="text-sm text-[#2D1654]/65 font-jost mt-1 font-medium">{item.v}</p>
              </div>
            ))}
          </div>
        </div>
