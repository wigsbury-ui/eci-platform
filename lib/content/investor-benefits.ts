...
export const INVESTOR_BENEFITS_INTRO = {
  ...
  summary:
    'Brand licensing with ECI is a commercial relationship: you fund and operate the campus; we supply a transferable school product, brand equity, and an operating standard already proven in market. Below is the hard case — not aspiration.',
} as const
