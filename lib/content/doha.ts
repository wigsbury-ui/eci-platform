...
export const DOHA_SCHOOL = {
  ...
  statusLabel: 'Founding campus',
  partner: 'Education Avenue Group',
  principal: 'Alya Muflihi',
  foundedYear: 2025,
  schoolYearStarts: 'September',
  academicSystem: 'British',
...
export const DOHA_HIGHLIGHTS = [
  {
    ...
    body: 'Modern teaching spaces, specialist facilities and outdoor provision designed for a full British-heritage school experience in Doha.',
  },
  {
    title: 'British curriculum pathways',
    body: 'Early Years Foundation Stage and British Primary, with English and Arabic as teaching languages in an academically selective setting.',
  },
  {
  ...
  },
  {
    ...
    body: 'Led by Principal Alya Muflihi, with close support from Ellesmere College International as the campus opens to its founding community.',
  },
] as const
...
export const DOHA_FACTS = [
  { label: 'Location', value: 'Doha, Qatar' },
  { label: 'Partner', value: 'Education Avenue Group' },
  { label: 'Curriculum', value: 'British · EYFS & Primary' },
  { label: 'Languages', value: 'English & Arabic' },
  { label: 'Principal', value: 'Alya Muflihi' },
  { label: 'School year', value: 'Starts September' },
] as const
